...
import { registerUser, loginUser, forgetPassword, resetPassword, verifyOtp, changeProfile, changePassword, getMyProfile, getGeoData } from "../controllers/authController.js";
...
authRouter
  ...
  .get('/get-geo-data', upload.none(), getGeoData)
